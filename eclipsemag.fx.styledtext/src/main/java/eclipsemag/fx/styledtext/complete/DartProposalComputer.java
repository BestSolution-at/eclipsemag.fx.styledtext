...
public class DartProposalComputer implements ProposalComputer {
	...
	private static Image PROPERTY_ADORNMENT = new Image(DartProposalComputer.class.getResource("icons/property.png").toExternalForm());
	private static Image FIELD_PRIVATE = new Image(DartProposalComputer.class.getResource("icons/field_private_obj.png").toExternalForm());
	private static Image FIELD_PUBLIC = new Image(DartProposalComputer.class.getResource("icons/field_public_obj.png").toExternalForm());
	private static Image METHOD_PRIVATE = new Image(DartProposalComputer.class.getResource("icons/methpri_obj.png").toExternalForm());
	private static Image METHOD_PUBLIC = new Image(DartProposalComputer.class.getResource("icons/methpub_obj.png").toExternalForm());
